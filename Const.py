...
SINTAX = "La tua risposta deve contenere solo e soltanto il numero 0 o 1 che ritieni più opportuno secondo la domanda che ti è stata posta. Non devono esserci spazi o altri caratteri."
#SINTAX = "Il numero che hai scelto dovrà essere contenuto tra i tag <tag> e </tag> e non dovrà essere preceduto o seguito da altri caratteri o spazi."